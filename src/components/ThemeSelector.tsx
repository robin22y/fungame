...
import { THEMES, getCurrentTheme, setTheme } from '../utils/themeManager';
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl p-8">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-3xl font-bold text-gray-800">Theme Selector</h2>
      </div>

      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-4 mb-6 border-2 border-blue-200">
        <p className="text-gray-700 text-center">
          <span className="font-bold">Current Theme:</span> {currentTheme.emoji} {currentTheme.name}
        </p>
      </div>
